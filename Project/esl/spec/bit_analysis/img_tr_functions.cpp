...
void monochromating(unsigned char *img, unsigned char *gray_img, int width, int height, size_t img_size)
{
    unsigned char *p;
    unsigned char *pg;
...
void copying(unsigned char *img, unsigned char *same_img, int width, int height, size_t img_size)
{
    unsigned char *p;
    unsigned char *pg;
