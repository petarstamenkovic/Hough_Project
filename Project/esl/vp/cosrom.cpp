...
void CosRom::b_transport(pl_t &pl, sc_core::sc_time &offset)
{
	...
	switch(cmd)
	{
		case tlm::TLM_READ_COMMAND:
			...
			{
		  		value = (int16_t)(cosrom[addr++] << 14);
		  		buf[i] = (unsigned char)(value >> 8);
		  		buf[i+1] = (unsigned char)(value & 0xFF);
		  		//std::cout << "citanje iz cos_rom-a: ";
				//std::cout << "adresa: " << (int)(addr-1) << " " << cosrom[addr-1] <<", vrednosti: " << value << " " << std::hex << (int)buf[i] << " " << std::hex << (int)buf[i+1] << std::endl;
			}
